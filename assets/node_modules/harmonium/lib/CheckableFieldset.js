  ...
  _createClass(CheckableFieldset, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          help = _props.help,
          error = _props.error,
          props = _objectWithoutProperties(_props, ['label', 'className', 'children', 'help', 'error']);

      var fieldsetClassName = (0, _classnames2.default)(className, 'fieldset', 'rev-CheckableFieldset', {
