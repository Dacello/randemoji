...
var Tokenizer = function (_React$Component) {
  ...
  _createClass(Tokenizer, [{
    ...
    value: function getItemValue(item) {
      return (this.props.getItemValue || function (itemArg) {
        return itemArg.id;
      })(item);
    }
  }, {
    ...
    value: function setOptions(items) {
      ...
      var rejectItem = function rejectItem(item) {
        return (0, _lodash.includes)(_this6.getSelectedValues(), _this6.getItemValue(item));
      };

      this.setState({
        optionItems: (0, _lodash.reject)(items, rejectItem)
      });
    }
  }, {
    key: 'fetchOptions',
    ...
    value: function onSelect(item) {
      ...
      items.push(item);
      items = (0, _lodash.uniq)(items, null, this.getItemValue.bind(this));
      input.value = '';
      input.focus();
      this.clearOptions();
    ...
    value: function onRemove(item) {
      ...
      var items = (0, _lodash.reject)(this.state.selectedItems, function (arg) {
        return _this7.getItemValue(arg) === _this7.getItemValue(item);
      });
