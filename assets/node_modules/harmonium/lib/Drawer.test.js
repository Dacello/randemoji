...
describe('Drawer', function () {
  it('should render', function () {
    (0, _enzyme.shallow)(_react2.default.createElement(_Drawer2.default, null));
  });

  it('can handle boolean props', function () {
    var expander = (0, _enzyme.mount)(_react2.default.createElement(_Drawer2.default, { left: true })).find(_Drawer.Expander);

    expect(expander.prop('className')).to.contain('rev-Drawer--left');
  });

  it('can expand and collapse', function () {
    var drawer = (0, _enzyme.mount)(_react2.default.createElement(_Drawer2.default, { left: true }));
  ...
  it('should add className to child', function () {
    ...
    var input = (0, _enzyme.shallow)(_react2.default.createElement(_Drawer2.default, { className: testClassName })).find('.' + testClassName);
