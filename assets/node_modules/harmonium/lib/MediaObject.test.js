...
describe('MediaObject', function () {
  it('should render without throwing', function () {
    (0, _enzyme.shallow)(_react2.default.createElement(_MediaObject2.default, null));
  });

  it('it handles boolean props', function () {
    var mediaObject = (0, _enzyme.shallow)(_react2.default.createElement(_MediaObject2.default, { center: true }));
...
describe('MediaObjectSection', function () {
  it('should render without throwing', function () {
    (0, _enzyme.shallow)(_react2.default.createElement(_MediaObject2.default.Section, null));
  });

  it('it handles boolean props', function () {
    var mediaObject = (0, _enzyme.shallow)(_react2.default.createElement(_MediaObject2.default.Section, { center: true }));
