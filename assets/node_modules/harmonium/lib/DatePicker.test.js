...
describe('DatePicker', function () {
  it('should render without throwing', function () {
    (0, _enzyme.shallow)(_react2.default.createElement(_DatePicker2.default, null));
  });

  it('should add className to child', function () {
    var testClassName = '__TEST__';

    var input = (0, _enzyme.shallow)(_react2.default.createElement(_DatePicker2.default, { className: testClassName })).find('.' + testClassName);

    expect(input.exists()).to.equal(true);
  });

  it('should handle external date changes', function () {
    var input = (0, _enzyme.mount)(_react2.default.createElement(_DatePicker2.default, { defaultValue: '2018-03-12' }));
  ...
  it('should handle external date changes', function () {
    ...
    var input = (0, _enzyme.mount)(_react2.default.createElement(_DatePicker2.default, { defaultValue: '2018-03-12', onChange: spy }));
  ...
  it('should translate clicks on calendar cells into changes', function () {
    var spy = _sinon2.default.spy();
    var input = (0, _enzyme.mount)(_react2.default.createElement(_DatePicker2.default, { defaultValue: '2018-03-12', isOpen: true, onChange: spy }));
  ...
  it('opens the calendar on focus and hides it on blur', function () {
    ...
    var input = (0, _enzyme.mount)(_react2.default.createElement(_DatePicker2.default, { onBlur: blurSpy, onFocus: focusSpy }));
  ...
  it('keeps the calendar open when you do not have focus, but the mouse is over', function () {
    var input = (0, _enzyme.mount)(_react2.default.createElement(_DatePicker2.default, null));
  ...
  it('can make items not selectable', function () {
    var spy = _sinon2.default.spy();
    var input = (0, _enzyme.mount)(_react2.default.createElement(_DatePicker2.default, {
  ...
  it('does overrides', function () {
    ...
    var input = (0, _enzyme.mount)(_react2.default.createElement(_DatePicker2.default, {
      overrides: _defineProperty({}, _DatePicker2.default.Calendar, overrideComponent),
      isOpen: true
    }));
