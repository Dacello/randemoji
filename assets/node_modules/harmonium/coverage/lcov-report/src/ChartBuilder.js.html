...
<html lang="en">
<head>
    <title>Code coverage report for src/ChartBuilder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> ChartBuilder.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Chart from 'chart.js'
...
<span class="cstat-no" title="statement not covered" >    this.destroyChart()</span>
  }
&nbsp;
  get ctx() {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ge</span>t chartFuncName() {
<span class="cstat-no" title="statement not covered" >    return this.props.type</span>
  }
&nbsp;
  get options() {
...
&nbsp;
  createChart() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._chart) {
<span class="cstat-no" title="statement not covered" >      throw new Error('`createChart` may only be called once.`')</span>
    }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  de</span>stroyChart() {
<span class="cstat-no" title="statement not covered" >    this._chart.destroy()</span>
  }
&nbsp;
  render() {
    return (
