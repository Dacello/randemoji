...
<html lang="en">
<head>
    <title>Code coverage report for src/Form.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Form.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    const actualMethod = overrideMethod ? <span class="branch-0 cbranch-no" title="branch not covered" >'post' </span>: method
&nbsp;
    return (
      &lt;form {...props} className={formClassName} method={actualMethod}&gt;
        &lt;AuthenticityToken /&gt;
        {overrideMethod &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >          &lt;input type="hidden" name={methodOverrideInputName} value={method} /&gt;</span>
        )}
        {children}
      &lt;/form&gt;
    )
