...
<html lang="en">
<head>
    <title>Code coverage report for src/Card.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Card.js
    </h1>
    <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >  re</span>nder() {
    const {className, children} = <span class="cstat-no" title="statement not covered" >this.props</span>
&nbsp;
