...
<html lang="en">
<head>
    <title>Code coverage report for src/Accordion.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Accordion.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, {Children, cloneElement, Component} from 'react'
...
&nbsp;
  rewriteChild = (child) =&gt; {
    ...
    const newOnClick = (e, ...args) =&gt; {
      e.preventDefault()
      this[multi ? <span class="branch-0 cbranch-no" title="branch not covered" >'toggleActiveStatus' </span>: 'setExclusivelyActive'](contentKey)
      <span class="missing-if-branch" title="else path not taken" >E</span>if (onClick) {
