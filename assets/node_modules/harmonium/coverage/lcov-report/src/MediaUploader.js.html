...
<html lang="en">
<head>
    <title>Code coverage report for src/MediaUploader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> MediaUploader.js
    </h1>
    <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >  va</span>lidateFile(file) {
    const {
      supportedFileTypes,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (utils.isTooBig(file, maxFileSize)) {</span>
<span class="cstat-no" title="statement not covered" >      this.setState({errorMessage: maxFileSizeMessage})</span>
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (utils.isUnsupportedFileType(file, supportedFileTypes)) {</span>
<span class="cstat-no" title="statement not covered" >      this.setState({errorMessage: supportedFileTypesMessage})</span>
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
&nbsp;
...
&nbsp;
  ...
  updatePreview = <span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
    const {getS3Info} = <span class="cstat-no" title="statement not covered" >this.props</span>
    const reader = <span class="cstat-no" title="statement not covered" >new FileReader()</span>
    const input = <span class="cstat-no" title="statement not covered" >e.target</span>
    const file = <span class="cstat-no" title="statement not covered" >e.target.files[0]</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    reader.addEventListener('load', <span class="fstat-no" title="function not covered" >as</span>ync () =&gt; {</span>
      const valid = <span class="cstat-no" title="statement not covered" >this.validateFile(file)</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.setState({</span>
        ...
        let url = <span class="cstat-no" title="statement not covered" >reader.result</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (getS3Info) {</span>
<span class="cstat-no" title="statement not covered" >          url = await utils.uploadFileToS3(file, getS3Info)</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.setState({</span>
          imagePreviewUrl: url,
