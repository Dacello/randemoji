...
<html lang="en">
<head>
    <title>Code coverage report for src/DatePicker/DateInputBlock.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/DatePicker</a> DateInputBlock.js
    </h1>
    <div class='clearfix'>
    ...
    return (
      &lt;div&gt;
        &lt;Input
          ...
          type={goodDateInput ? 'date' : <span class="branch-1 cbranch-no" title="branch not covered" >'text'}</span>
          name={goodDateInput ? name : <span class="branch-1 cbranch-no" title="branch not covered" >null}</span>
          defaultValue={formattedValue}
          /*         have a placeholder to avoid empty box on Firefox  */
          placeholder={dateFormat ? <span class="branch-0 cbranch-no" title="branch not covered" >dateFormat </span>: 'mm/dd/yyyy'}
        /&gt;
        {goodDateInput ? null : (
