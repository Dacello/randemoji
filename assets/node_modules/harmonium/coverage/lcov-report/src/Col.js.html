...
<html lang="en">
<head>
    <title>Code coverage report for src/Col.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Col.js
    </h1>
    <div class='clearfix'>
...
const NUMBER_PROPS_TO_CLASS_NAMES = {
  ...
  xlarge: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xlarge${arg}`],</span>
  xxlarge: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xxlarge${arg}`],</span>
&nbsp;
  smallOffset: (arg) =&gt; [`rev-Col--smallOffset${arg}`],
  mediumOffset: (arg) =&gt; [`rev-Col--mediumOffset${arg}`,],
  largeOffset: (arg) =&gt; [`rev-Col--largeOffset${arg}`],
  xlargeOffset: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xlargeOffset${arg}`],</span>
  xxlargeOffset: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xxlargeOffset${arg}`],</span>
&nbsp;
  smallPush: (arg) =&gt; [`rev-Col--smallPush${arg}`],
  mediumPush: (arg) =&gt; [`rev-Col--mediumPush${arg}`],
  largePush: (arg) =&gt; [`rev-Col--largePush${arg}`],
  xlargePush: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xlargePush${arg}`],</span>
  xxlargePush: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xxlargePush${arg}`],</span>
&nbsp;
  smallPull: (arg) =&gt; [`rev-Col--smallPull${arg}`],
  mediumPull: (arg) =&gt; [`rev-Col--mediumPull${arg}`],
  largePull: (arg) =&gt; [`rev-Col--largePull${arg}`],
  xlargePull: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xlargePull${arg}`],</span>
  xxlargePull: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xxlargePull${arg}`],</span>
&nbsp;
  smallOrder: (arg) =&gt; [`rev-Col--smallOrder${arg}`],
  mediumOrder: (arg) =&gt; [`rev-Col--mediumOrder${arg}`],
  largeOrder: (arg) =&gt; [`rev-Col--largeOrder${arg}`],
  xlargeOrder: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xlargeOrder${arg}`],</span>
  xxlargeOrder: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Col--xxlargeOrder${arg}`],</span>
}
&nbsp;
