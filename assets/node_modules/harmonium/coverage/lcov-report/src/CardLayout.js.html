...
<html lang="en">
<head>
    <title>Code coverage report for src/CardLayout.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> CardLayout.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    BOOL_PROPS.forEach((name) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (props[name]) {
<span class="cstat-no" title="statement not covered" >        boolClassNames.push(BOOL_PROPS_TO_CLASS_NAMES[name])</span>
      }
      delete props[name]
    })
&nbsp;
...
<span class="fstat-no" title="function not covered" >  re</span>nder() {
    const {className, children, ...props} = <span class="cstat-no" title="statement not covered" >this.props</span>
    const divClassName = <span class="cstat-no" title="statement not covered" >classNames(className, 'rev-CardLayout-fill')</span>
&nbsp;
