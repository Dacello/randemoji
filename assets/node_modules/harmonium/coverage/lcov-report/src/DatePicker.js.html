...
<html lang="en">
<head>
    <title>Code coverage report for src/DatePicker.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> DatePicker.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  get dateFormat() {
    ...
    return this.goodDateInput
      ? 'yyyy-MM-dd'
      : <span class="branch-1 cbranch-no" title="branch not covered" >this.props.dateFormat || 'MM/dd/yyyy'</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
  refocus() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.nativeInput) {
...
&nbsp;
  ...
  get calendarOpened() {
    return (
      ...
      !this.props.disabled &amp;&amp;
      (!this.useNativePicker() || <span class="branch-4 cbranch-no" title="branch not covered" >this.props.useCalendarOnMobile)</span>
    )
  }
&nbsp;
  /**
...
&nbsp;
  ...
  onOutsideClick(event) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (
      this.state.isOpen &amp;&amp;
      this.calendar &amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >      !this.calendar.contains(event.target)</span>
    ) {
<span class="cstat-no" title="statement not covered" >      event.preventDefault()</span>
<span class="cstat-no" title="statement not covered" >      this.blur(event)</span>
<span class="cstat-no" title="statement not covered" >      this.mouseOut()</span>
    }
  }
&nbsp;
  render() {
    ...
    const nativeClass = this.useNativePicker()
      ? <span class="branch-0 cbranch-no" title="branch not covered" >'rev-DatePicker--native'</span>
