...
<html lang="en">
<head>
    <title>Code coverage report for src/DatePicker/Calendar.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/DatePicker</a> Calendar.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/** @jsx createElement */
...
&nbsp;
    return {
      ...
      dateChanger: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span>
      focuser: () =&gt; null,
      isSelectable: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >true,</span>
    }
  }
&nbsp;
  /**
...
&nbsp;
  ...
  addMonth(num, event) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.focuser) {
      this.props.focuser()
    }
  }
&nbsp;
   ...
   * @return {void}
   */
<span class="fstat-no" title="function not covered" >  ad</span>dYear(num, event) {
...
<span class="cstat-no" title="statement not covered" >    if (this.props.focuser) {</span>
<span class="cstat-no" title="statement not covered" >      this.props.focuser()</span>
    }
  }
&nbsp;
  render() {
    ...
    return (
      &lt;div
        ...
        className={`rev-Calendar ${
          overlay ? <span class="branch-0 cbranch-no" title="branch not covered" >'rev-Calendar--overlay' </span>: ''
        } ${className}`}
      &gt;
        &lt;Card getCalendarRef={getCalendarRef}&gt;
          &lt;Card.Header className="rev-Calendar-header"&gt;
            ...
            &lt;/span&gt;
            {showYearSelection &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >              &lt;div className="rev-Calender-year-selection"&gt;</span>
                &lt;Button
                  small
