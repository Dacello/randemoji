...
<html lang="en">
<head>
    <title>Code coverage report for src/Menu.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Menu.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    const newClassName = classNames(`rev-Menu-item ${className || <span class="branch-1 cbranch-no" title="branch not covered" >''}</span>`, {
