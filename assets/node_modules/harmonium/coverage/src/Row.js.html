...
<html lang="en">
<head>
    <title>Code coverage report for src/Row.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Row.js
    </h1>
    <div class='clearfix'>
...
const NUMBER_PROPS_TO_CLASS_NAMES = {
  ...
  xlargeUp: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Row--xlargeUp${arg}`],</span>
  xxlargeUp: <span class="fstat-no" title="function not covered" >(a</span>rg) =&gt; <span class="cstat-no" title="statement not covered" >[`rev-Row--xxlargeUp${arg}`],</span>
}
&nbsp;
