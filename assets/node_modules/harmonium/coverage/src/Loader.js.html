...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Loader.js
    </h1>
    <div class='clearfix'>
 ...
 **/
function inc(num = <span class="branch-0 cbranch-no" title="branch not covered" >0)</span> {
  return num + 1
}
&nbsp;
export default class Loader extends Component {
   ...
   **/
  sumPropsInObj(attrs = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> obj = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
&nbsp;
   ...
   * throws an error.
   **/
  ensureNoConflicts(props = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
&nbsp;
   ...
   **/
  resolveClassNames(props = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
&nbsp;
   ...
   **/
  resolveStyles(props = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const styles = {
