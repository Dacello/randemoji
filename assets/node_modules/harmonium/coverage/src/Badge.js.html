...
<html lang="en">
<head>
    <title>Code coverage report for src/Badge.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Badge.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    return (
      &lt;span {...props} className={newClassName}&gt;
        {icon ? <span class="branch-0 cbranch-no" title="branch not covered" >&lt;Icon i={icon} className="rev-Badge-icon" /&gt; </span>: null} {children}
      &lt;/span&gt;
    )
  }
}
