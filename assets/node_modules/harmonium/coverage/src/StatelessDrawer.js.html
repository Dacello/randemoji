...
<html lang="en">
<head>
    <title>Code coverage report for src/StatelessDrawer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> StatelessDrawer.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  expand = () =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.expand) {
      this.props.expand()
    }
  }
&nbsp;
  close = () =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.close) {
      this.props.close()
    }
  }
&nbsp;
