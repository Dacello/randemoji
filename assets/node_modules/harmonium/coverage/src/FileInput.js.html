...
<html lang="en">
<head>
    <title>Code coverage report for src/FileInput.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> FileInput.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.props.onChange) {
<span class="cstat-no" title="statement not covered" >      return this.props.onChange(e, ...rest)</span>
    }
    return null
  }
&nbsp;
