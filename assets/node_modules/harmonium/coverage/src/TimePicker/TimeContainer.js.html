...
<html lang="en">
<head>
    <title>Code coverage report for src/TimePicker/TimeContainer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/TimePicker</a> TimeContainer.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.refocusOnClick) {
    ...
    return (
      &lt;div
        className={`rev-TimeContainer ${
          overlay ? <span class="branch-0 cbranch-no" title="branch not covered" >'rev-TimeContainer--overlay' </span>: ''
        } ${className}`}
      &gt;
        &lt;Card&gt;
          &lt;Card.Header&gt;
          ...
          &lt;Card.Body&gt;
            ...
            {use24hr ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: (
              &lt;TimeTicker
