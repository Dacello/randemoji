...
<html lang="en">
<head>
    <title>Code coverage report for sassy-npm-importer/src/Importer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">sassy-npm-importer/src</a> Importer.js
    </h1>
    <div class='clearfix'>
...
65
66
67</td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
&nbsp;
  if (this.options.prefix != null) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof(this.options.prefix) !== 'string') {
<span class="cstat-no" title="statement not covered" >      throw new Error('options.prefix must be string');</span>
    }
  }
&nbsp;
  this.debug = function () {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.debug) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Jan 31 2018 11:08:59 GMT-0600 (CST)
</div>
</div>
